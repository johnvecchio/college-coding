...
${OBJECTDIR}/Gun/Revolver.o: Gun/Revolver.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gun/Revolver.o Gun/Revolver.cpp

${OBJECTDIR}/Gun/HandGun.o: Gun/HandGun.cpp 
	${MKDIR} -p ${OBJECTDIR}/Gun
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gun/HandGun.o Gun/HandGun.cpp

${OBJECTDIR}/Gun/Pistol.o: Gun/Pistol.cpp 
	${MKDIR} -p ${OBJECTDIR}/Gun
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gun/Pistol.o Gun/Pistol.cpp

${OBJECTDIR}/Gun/Gun.o: Gun/Gun.cpp 
	${MKDIR} -p ${OBJECTDIR}/Gun
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gun/Gun.o Gun/Gun.cpp

${OBJECTDIR}/GunInherMain.o: GunInherMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/GunInherMain.o GunInherMain.cpp
